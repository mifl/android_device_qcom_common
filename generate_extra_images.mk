...
ifeq ($(TARGET_BOOTIMG_SIGNED),true)
INSTALLED_SEC_2K_BOOTIMAGE_TARGET := $(2K_NAND_OUT)/boot.img.secure
INSTALLED_SEC_4K_BOOTIMAGE_TARGET := $(4K_NAND_OUT)/boot.img.secure
endif
...
ifeq ($(TARGET_BOOTIMG_SIGNED),true)
$(INSTALLED_SEC_4K_BOOTIMAGE_TARGET): $(INSTALLED_4K_BOOTIMAGE_TARGET) $(RECOVERY_FROM_BOOT_PATCH)
	$(hide) $(call build-boot-image,$(INSTALLED_4K_BOOTIMAGE_TARGET),$(INTERNAL_4K_BOOTIMAGE_ARGS))
ifeq ($(call is-board-platform,msm7627a),true)
	$(hide) $(call build-boot-image,$(INSTALLED_2K_BOOTIMAGE_TARGET),$(INTERNAL_2K_BOOTIMAGE_ARGS))
endif
endif
...
ALL_DEFAULT_INSTALLED_MODULES += \
	...
	$(INSTALLED_SEC_4K_BOOTIMAGE_TARGET) \
...
.PHONY: kernel
kernel: $(INSTALLED_BOOTIMAGE_TARGET) $(INSTALLED_SEC_BOOTIMAGE_TARGET) $(INSTALLED_4K_BOOTIMAGE_TARGET) $(INSTALLED_SEC_4K_BOOTIMAGE_TARGET)
