...
PRODUCT_COPY_FILES += \
    ...
    device/qcom/common/android.hardware.location.gps.xml:system/etc/permissions/android.hardware.location.gps.xml \
...
PRODUCT_BRAND := qcom
PRODUCT_LOCALES := en_US es_US de_DE zh_CN fr_FR ja_JP en_GB
